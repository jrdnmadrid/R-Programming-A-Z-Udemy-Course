...
#Construct a matrix using rbind to bind each set of rows.
...
# Challenge #1: Free Throw Attempts Per Game

FreeThrowAttemptsPerGame <- FreeThrowAttempts / Games

FreeThrowAttemptsPerGame

matplot(t(FreeThrowAttemptsPerGame), type = "b", pch = 15:18, col = c(1:4, 6))
legend("bottomleft", inset = 0.00, legend = Players, col = c(1:4, 6), pch = 15:18, horiz = F)

#Challenge #2: Accuracy of Free Throws
Accuracy <- FreeThrows / FreeThrowAttempts
...
#Challenge #3: Player Playing style (2 vs 3 points preference excluding Free Throws)
